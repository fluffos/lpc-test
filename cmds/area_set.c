...
int help()
{
    string msg = "這是用來設定區域目前所處座標的相關資料的指令。\n"
            ...
            BBLU "\n2. 指令格式： sa loads" NOR
                 "\n   查詢區域中會載入对象的所有座標列表。\n"
            BBLU "\n3. 指令格式： sa loads FILE_NAME AMOUNT" NOR
